...
export default function WeddingDetailsSection({ 
  ...
  const cardBaseStyles = "relative bg-[#fdfcf0] border-2 border-black p-8 md:p-10 flex-1 flex flex-col shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] cursor-default";
    ...
    <section className="relative min-h-screen w-full flex items-center justify-center bg-[#1a1a1a] py-20 px-4 md:px-10 overflow-hidden font-sans">
        ...
        >
          ...
          <div className="flex-grow flex flex-col items-center justify-center">
            <div className="relative w-full h-48 mb-4">
              <Image 
                src="/img-rock/dress-rockabilly.png" 
                alt="Dress Code" 
                fill 
                className="object-contain" 
              />
      ...
      <DetailModal isOpen={activeModal === "dress"} onClose={() => setActiveModal(null)} title="Dress Code">
        ...
        <p className="text-lg italic text-black/80 border-t-2 border-black/10 pt-4">
          {dressDescription || "¡Saca tus cueros, tus mejores faldas de vuelo y mucho fijador para el pelo!"}
        </p>
      </DetailModal>

      {/* MODAL REGALOS */}
      <DetailModal isOpen={activeModal === "gift"} onClose={() => setActiveModal(null)} title="Regalos">
        <p className="mb-6 font-bold italic text-black text-center">
