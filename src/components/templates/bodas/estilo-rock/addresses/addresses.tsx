          ...
          {sectionData.map((item, index) => (
            ...
            >
              ...
              <div className="mb-3 relative w-16 h-16">
                 <Image src={item.icon} alt="icon" fill className="object-contain drop-shadow-md" sizes="64px" />
              </div>
              ...
              {/* Imagen con borde - CORREGIDO */}
              <div className="relative p-1 border-2 border-dashed border-[#a02133] rounded-sm mb-5 bg-transparent w-full max-w-[320px]">
                <div className="relative w-full aspect-video md:w-[320px] md:h-[180px] overflow-hidden">
                   <Image 
                    src={item.image} 
                    alt={item.title} 
                    fill 
