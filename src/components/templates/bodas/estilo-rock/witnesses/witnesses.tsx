...
// 1. Interface conectada a tu Prisma Schema
...
interface SeccionTestigosProps {
  items: WitnessItem[];
}

export default function SeccionTestigos({ items }: SeccionTestigosProps) {
  ...
  return (
    ...
    <section className="relative py-20 bg-[#33aba1] min-h-screen overflow-hidden flex flex-col justify-center font-serif">
      {/* Fondo de puntos blancos estilo retro */}
      <div 
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Contenedor de Testigos Dinámico */}
        <div className="relative max-w-6xl mx-auto group">
          
          {/* Sombra de capa beige (Efecto Sticker/Papel) */}
          ...
          <div className="relative z-10 bg-white border-[2px] border-black flex flex-col md:flex-row items-stretch shadow-md overflow-hidden 
            ...
            {items.map((testigo, index) => (
              ...
              >
                ...
                {/* Texto del Testigo mapeado desde DB */}
