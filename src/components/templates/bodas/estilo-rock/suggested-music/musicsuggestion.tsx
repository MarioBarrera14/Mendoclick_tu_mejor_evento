  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!songs.tema1 && !songs.tema2 && !songs.tema3) {
      Swal.fire({ 
        ...
        text: "¡Escribe al menos una canción para el DJ!", 
        icon: "warning", 
        confirmButtonColor: "#a02133" 
      });
      return;
    ...
    try {
      ...
      Swal.fire({ 
        title: "Error", 
        text: "Hubo un fallo de conexión.", 
        icon: "error", 
        confirmButtonColor: "#a02133" 
      });
    } finally {
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-2xl mx-auto bg-[#fdfcf0] border-4 border-black p-8 md:p-12 shadow-[12px_12px_0px_0px_#a02133] text-center relative overflow-hidden rotate-[-0.5deg]">
            ...
            <div className="flex justify-center">
              <button onClick={() => setIsOpen(true)} className={`${buttonBase} ${buttonBorder}`}>
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                  ...
                  <div className="pt-4 flex justify-center">
                    <button
                      type="submit"
                      disabled={isSending}
                      className={`${buttonBase} ${buttonBorder} bg-[#33aba1] w-full disabled:opacity-50`}
                    >
