      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-0 m-auto w-[90%] max-w-lg h-fit bg-[#fdfcf0] p-8 md:p-12 z-[101] border-4 border-black text-center touch-auto"
      ...
      <section className="relative min-h-screen w-full flex items-center justify-center bg-[#1a1a1a] py-20 px-4 md:px-10 overflow-hidden">
        ...
        <DetailModal isOpen={activeModal === "gift"} onClose={() => setActiveModal(null)} title="Regalos" shadowColor={colorRoja}>
          ...
          <div className="space-y-4">
            <motion.div animate={{ rotate: -1 }} className="bg-[#b02a30] p-4 border-2 border-black mb-8" style={{ boxShadow: `4px 4px 0px 0px ${colorRoja}` }}>
