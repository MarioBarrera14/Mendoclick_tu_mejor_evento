...
export function Footer() {
  ...
  return (
    <footer className="relative pt-16 pb-8 overflow-hidden bg-[#1a1a1a] mt-[-1px]">
      ...
      <div 
        className="absolute inset-0 z-0 opacity-10 bg-[radial-gradient(circle,#4fb0a2_1px,transparent_1px)] bg-[size:20px_20px]"
      />
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col items-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8 w-full justify-center">
            ...
            >
              <Instagram className="w-4 h-4" /> {contacto.instagram || "@mendo.click"}
            </motion.a>
          </div>
        ...
        <button 
          onClick={scrollToTop} 
          className="group flex flex-col items-center gap-1 mt-10 text-[#fdfcf0]/60 hover:text-[#4fb0a2] transition-colors z-30 appearance-none bg-transparent border-none outline-none"
        >
      ...
      {/* Marca de agua (Tailwind puro) */}
      <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 text-[10vw] font-black italic text-white/5 whitespace-nowrap z-0 select-none pointer-events-none uppercase">
        {footer.marca}
      </div>
    </footer>
  );
