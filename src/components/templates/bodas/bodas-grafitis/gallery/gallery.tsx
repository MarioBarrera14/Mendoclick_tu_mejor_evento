...
export function FotoCarousel({
  ...
  // --- 1. DEFINICIÓN DE TODOS LOS HOOKS (Siempre al principio) ---
  ...
  // Hook de procesamiento de fotos
  ...
  // IMPORTANTE: Se coloca DESPUÉS de los hooks para evitar el error de Next.js
  ...
  return (
    ...
    <section className="relative py-12 bg-gradient-to-b from-[#649a8d] via-[#a8c9b3] to-[#f7e6c4] overflow-hidden mb-[-1px] font-['Permanent_Marker',_cursive]">
      ...
      <div className="container mx-auto px-6 mb-8 text-center flex flex-col items-center relative z-10">
        ...
        <motion.span className="text-lg text-black mb-2 italic">Nuestra Historia</motion.span>

        <h3 className="text-4xl md:text-6xl text-black mb-4 tracking-tight uppercase">Momentos Inolvidables</h3>
      ...
      {/* CARRUSEL DE FOTOS (PREMIUM Y DELUXE) */}
            ...
            <div className="relative aspect-video overflow-hidden rounded-[1.5rem] bg-white shadow-xl group border border-[#94A994]/20">
              ...
              {videoUrl ? (
                ...
                <div className="w-full h-full flex flex-col items-center justify-center text-[#94A994] bg-[#FDFDFD]">
                  ...
                  <p className="text-sm text-black uppercase font-bold tracking-widest">Video próximamente</p>
      ...
      <AnimatePresence>
        ...
        {isVideoModalOpen && videoUrl && plan === "DELUXE" && (
