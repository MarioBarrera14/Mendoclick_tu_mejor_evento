              ...
              <div className="p-12 text-center">
                ...
                <div className="space-y-6">
                  <input 
                    ...
                    className="w-full bg-gray-50 border border-gray-100 px-6 py-5 rounded-xl text-center text-sm tracking-[0.2em] uppercase focus:outline-none focus:ring-2 focus:ring-[#b5a47a]/10 transition-all shadow-inner text-black"
                  />
