...
export const Navbar = ({ eventName, isDemo = false }: NavbarProps) => {
  ...
  // Fallback para el nombre si no viene de la base de datos
  const displayName = eventName || "Nuestra Boda";
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-6"> 
          ...
          {isDemo ? (
            ...
            /* MODO CLIENTE: Aparece según el estado de sesión */
            <>
              {/* LOGIN (Invitado/Cliente) */}
