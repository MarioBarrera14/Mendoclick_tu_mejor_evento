...
export function Itinerary() {
  const steps: ItineraryItem[] = [
    { time: "21:00hs", title: "Recepción", icon: <GlassWater size={20} strokeWidth={1.5} /> },
    { time: "22:30hs", title: "Entrada", icon: <Star size={20} strokeWidth={1.5} /> },
    { time: "23:00hs", title: "Brindis", icon: <GlassWater size={20} strokeWidth={1.5} /> },
    { time: "23:30hs", title: "Cena", icon: <Utensils size={20} strokeWidth={1.5} /> },
    { time: "01:00hs", title: "Vals", icon: <Sparkles size={20} strokeWidth={1.5} /> },
    { time: "01:30hs", title: "Baile", icon: <PartyPopper size={20} strokeWidth={1.5} /> },
    { time: "03:30hs", title: "Candy Bar", icon: <Star size={20} strokeWidth={1.5} /> },
    { time: "05:00hs", title: "Souvenirs", icon: <Gift size={20} strokeWidth={1.5} /> },
  ];

  return (
    <section className="relative py-8 md:py-12 bg-[#F2E8D9] overflow-hidden font-sans">
      {/* SEPARADOR SUPERIOR - Reducido en altura */}
