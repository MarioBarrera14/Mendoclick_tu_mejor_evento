  ...
  return (
    <section className="relative py-12 bg-white overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center mb-8">
        ...
        >
          Desde muy pequeña tengo dos grandes pasiones... patinar y los peluditos de cuatro patas, 
          y andando sobre ruedas llegué a mis 15 años. Si hay algo que aprendí, es que es importante 
          celebrar cada momento rodeados de las personas que nos llenan el corazón...
        </motion.p>
      </div>
