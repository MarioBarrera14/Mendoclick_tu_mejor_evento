         ...
         <div className="container mx-auto px-6">
           <div className="grid grid-cols-1 md:grid-cols-4 gap-16 md:gap-12 mb-16 items-center md:items-start">
             ...
             <div className="col-span-1 md:col-span-2 flex flex-col items-center md:items-start text-center md:text-left">
               <div className="flex items-center gap-3 mb-6 justify-center md:justify-start">
                 <div className="w-10 h-10 bg-[#33aba1] rounded-xl flex items-center justify-center font-black italic text-xl shadow-[0_10px_20px_rgba(220,38,38,0.2)] text-white">
                   M
                 </div>
               ...
               <div className="flex gap-4 justify-center md:justify-start w-full">
                 <a href="#" className="w-10 h-10 rounded-full border border-black/5 flex items-center justify-center hover:bg-[#33aba1] hover:text-white transition-all text-zinc-400 hover:border-[#33aba1] shadow-sm">
                   <FiInstagram />
                 </a>
                 <a href="#" className="w-10 h-10 rounded-full border border-black/5 flex items-center justify-center hover:bg-[#33aba1] hover:text-white transition-all text-zinc-400 hover:border-[#33aba1] shadow-sm">
                   <FiTwitter />
             ...
             <div className="flex flex-col items-center md:items-start">
               ...
               <ul className="space-y-4 text-[10px] font-bold uppercase tracking-widest text-zinc-500">
                 <li><a href="#" className="hover:text-[#33aba1] transition">Inicio</a></li>
                 <li><a href="#modelos" className="hover:text-[#33aba1] transition">Colección</a></li>
                 <li><a href="#experiencia" className="hover:text-[#33aba1] transition">Tecnología</a></li>
               </ul>
             </div>
           ...
           <div className="border-t border-black/5 pt-10 flex flex-col justify-center items-center gap-10 text-center w-full">
             ...
             <motion.button 
               ...
               onClick={scrollToTop} 
               className="group flex flex-col items-center gap-2 text-[#33aba1] hover:scale-110 transition-transform z-30 appearance-none bg-transparent border-none outline-none cursor-pointer"
             >
