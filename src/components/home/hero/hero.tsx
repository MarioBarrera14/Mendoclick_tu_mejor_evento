...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white pt-20 md:pt-0">
      ...
      <div 
        className="absolute inset-0 z-0 bg-zinc-200 [clip-path:polygon(0_0,100%_0,100%_92%,0%_100%)] md:[clip-path:polygon(0_0,100%_0,100%_85%,0%_100%)]"
      >
        <Image 
      ...
      <motion.div 
        ...
        className="container mx-auto z-10 px-6 flex flex-col lg:flex-row items-center justify-between gap-10 md:gap-12"
      >
        {/* --- TEXTO IZQUIERDA --- */}
        <div className="flex-1 text-center lg:text-left mt-4 md:mt-0 order-2 lg:order-1">
          <motion.div
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
          >
            <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black leading-[0.85] md:leading-[0.8] uppercase italic tracking-tighter mb-4 text-white drop-shadow-2xl">
              MENDO<br/>
              <span className="text-white">CLICK!</span>
            </h1>
            
            <div className="h-1.5 w-20 bg-red-600 mb-6 mx-auto lg:mx-0" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <a 
                href="#modelos" 
                className="w-full sm:w-auto px-8 py-4 border-2 border-white text-white text-[10px] font-black tracking-[0.2em] rounded-full hover:bg-white hover:text-zinc-900 transition-all duration-300 uppercase shadow-lg text-center"
                >
                Modelos y Precios
                </a>
            </div>
        ...
        {/* --- SMARTPHONE --- */}
        <div className="flex-1 flex justify-center relative order-1 lg:order-2 scale-90 sm:scale-100">
          ...
          <motion.div 
            ...
            className="relative w-[230px] sm:w-[260px] md:w-[300px] aspect-[9/18.5] border-[6px] md:border-[8px] border-zinc-900 rounded-[2.5rem] bg-zinc-100 shadow-[0_40px_80px_-15px_rgba(0,0,0,0.6)] z-20 overflow-hidden"
          >
            {/* Notch del Teléfono */}
